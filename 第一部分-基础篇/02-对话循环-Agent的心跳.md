...
![异步生成器的生产者-消费者模型示意图](../assets/fundamentals/async_generator_diagram.png)
...
![消息类型体系图](../assets/fundamentals/message_types_diagram.png)
...
![对话循环的 Turn 生命周期示意图](../assets/fundamentals/turn_lifecycle_diagram.png)
...
![终止原因分类图](../assets/fundamentals/termination_reasons_diagram.png)
...
![状态转换模型图](../assets/fundamentals/state_transition_diagram.jpeg)
